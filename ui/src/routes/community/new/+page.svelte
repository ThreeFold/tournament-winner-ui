...
<form class="flex flex-col gap-3" method="POST" use:enhance>
    ...
    <button type="button" on:click={addLink} class="bg-slate-300 hover:bg-slate-400 rounded-md">Add Link</button>
    ...
    {/each}
    <button type="submit" class="ml-auto flex-end rounded-md p-2 bg-green-500 hover:bg-green-400">Create</button>
</form>
